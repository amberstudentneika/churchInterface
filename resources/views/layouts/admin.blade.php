  ...
  <div class="flex flex-row flex-wrap justify-center w-full h-screen bg-indigo-100 ">
    ...
    <div class="w-0 h-0 overflow-y-hidden bg-white shadow-lg md:w-1/4 lg:w-1/5 md:h-screen">
      ...
      <div class="flex flex-col w-full h-screen mt-8 antialiased hover:cursor-pointer">
        <a class="w-full p-3 text-xl font-semibold text-left text-black bg-blue-200 border-t-2 border-blue-200 hover:bg-blue-300" href="{{route('adminCategory')}}">
        ...
        <a class="w-full p-3 text-xl font-semibold text-left text-black bg-blue-200 border-t-2 border-gray-200 hover:bg-blue-300" href="{{route('adminFeed')}}">
          <svg xmlns="http://www.w3.org/2000/svg" class="float-right pt-1 pr-1 text-2xl text-black w-7 h-7" viewBox="0 0 20 20" fill="currentColor">
        ...
        <a class="w-full p-3 text-xl font-semibold text-left text-black bg-blue-200 border-t-2 border-gray-200 hover:bg-blue-300" href="{{route('adminAnnouncement')}}">
          <svg xmlns="http://www.w3.org/2000/svg" class="float-right pt-1 pr-1 text-2xl text-black w-7 h-7" viewBox="0 0 20 20" fill="currentColor">
            <path fill-rule="evenodd" d="M18 3a1 1 0 00-1.447-.894L8.763 6H5a3 3 0 000 6h.28l1.771 5.316A1 1 0 008 18h1a1 1 0 001-1v-4.382l6.553 3.276A1 1 0 0018 15V3z" clip-rule="evenodd" />
          </svg>Announcements</a>
        <a class="w-full p-3 text-xl font-semibold text-left text-black bg-blue-200 border-t-2 border-gray-200 hover:bg-blue-300" href="{{route('editProfilePhotoAdmin')}}">
          <svg xmlns="http://www.w3.org/2000/svg" class="float-right pt-1 pr-1 text-2xl text-black w-7 h-7" viewBox="0 0 20 20" fill="currentColor">
            <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" />
          </svg>Edit Profile</a>
