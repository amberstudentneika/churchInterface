...
<div class="flex flex-row flex-wrap w-full">
 ...
 <header class="grid w-full py-6 mx-auto bg-blue-900 border-b border-blue-300 shadow-lg grid-col">
        <div>
            <p class="flex justify-center text-2xl font-semibold font-extrabold text-white no-underline">
               Lewis Ministry
            </p>
        </div>
</header>
