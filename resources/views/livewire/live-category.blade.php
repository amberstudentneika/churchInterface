    ...
    <form wire:submit.prevent="goSubmit">
      ...
      <div class="flex justify-center">  
        <div class="flex flex-row items-center py-2">
          <a href="{{url('/feed')}}"><button type="button" wire:submit.prevent="" class="flex flex-row items-center px-2 py-2 bg-red-400 rounded-md focus:outline-none focus:shadow-outline">
